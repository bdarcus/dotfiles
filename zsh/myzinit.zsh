...
# setup curated meta package annex (a cool feature of zinit)
zinit light zinit-zsh/z-a-meta-plugins

# install select meta packages
...
# prezto modules
zinit snippet PZT::modules/dnf
zinit snippet PZT::modules/git

# History
# copied from https://gitlab.com/rawkode/dotfiles/-/blob/ee8837b88c574c6e9db94b8c0591133b5dd8a3a3/dotfiles/zsh/includes/history.zsh
##
# Plugins
##
